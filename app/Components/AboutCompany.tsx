...
export default function AboutCompany(){
    return(
        <section className="flex flex-col test min-w-[1440px] items-center">
            <div className="flex test justify-center w-3/4 text-center items-center m-[5rem]">
...
quality and outstanding customer service</h1>
            ...
            <div className="flex">
                <div className="w-[40%] test  m-[4rem] flex flex-col justify-between ">
...
over 400 outlets</h1>
                ...
                <div className="max-w-[50%] overflow-hidden"><img src="/about1.png" alt="" /></div>
            </div>
            <div className="flex test">
                <div className="max-w-[50%] test overflow-hidden"><img src="/about1.png" alt="" /></div>
